// https://webapps.stackexchange.com/questions/40292/is-there-a-way-to-link-a-choose-from-a-list-style-question-in-a-google-form-to
var FORMID = "";
var LIST_DATA = [{title:"Patient", sheet:"Patients"}];
...
function updateListChoices(item, sheetName){
  var data = (SpreadsheetApp.getActiveSpreadsheet()
              ...
              .getValues());
  var choices = [];
  for (var i = 1; i < data.length; i+=1){ // change: i=0 to i=1, ignore first row
